...
description: "An introduction to the SKALE Network - The blockchain for billions of agents"
---
...
SKALE is purpose-built to support billions of autonomous agents, enabling them to operate efficiently at scale with zero gas fees and instant finality.
...
> For more on SKALE Chain Pricing, checkout the [SKALE Pricing Page](/developers/run-a-skale-chain/pricing-and-payments).
...
> For more on the SKL token, deep dive [here](/concepts/skl-token).
...
with the zero gas fee model as well as other operational pieces of Ethereum that do not make sense on SKALE. For the full comparison,
checkout the [SKALE vs Ethereum](/developers/skale-vs-ethereum) page.
</Note>
...
If you are a developer looking to start building on SKALE, head over to the [Pick a Chain](/developers/pick-a-chain) page in the docs for a deeper dive
