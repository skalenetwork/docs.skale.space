...
To stake your SKL tokens, visit the [SKALE Portal Staking Page](https://portal.skale.network/staking).
...
This is set by the validator organization and can be found on the validator's page on the [SKALE Portal](https://portal.skale.network/validators).