...
As SKALE Chains are permissioned, you must be given permission by a chain owner or operator to deploy.
...
<Card title="Onboarding Form" href="https://onboarding.skale.space" />
...
For more information please check the [payments section](/developers/payments-on-skale).
...
will request that your scripts and smart contracts only use contract factories that adhere to the following:
   ...
   - The use of deterministic deployers, e.g [CREATE2Factory](https://github.com/Arachnid/deterministic-deployment-proxy), should be swapped out for [SKALE Deterministic Deploy](https://github.com/payvint/skale-deterministic-deployment-proxy).
...
For more information please check the [factories section](/developers/using-contract-factories).
...
You can find information about the different SKALE Chains Testnets [here](/get-started/chain-info).

## 4. Showcase your Project

Once you are ready to go to Mainnet, head over to the [Discord](https://discord.com/invite/gM5XBy6) and add your project in
