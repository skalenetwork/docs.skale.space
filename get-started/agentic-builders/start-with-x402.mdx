...
The x402 protocol enables agents to make and receive payments for services, allowing you to build autonomous payment-enabled applications on SKALE. This guide covers the essential concepts for building agents that interact with x402 payments.
...
- Creates and signs payment authorizations
