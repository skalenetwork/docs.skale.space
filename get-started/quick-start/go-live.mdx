...
The go-live process on SKALE can differ slightly from other chains and varies depending on what product within the SKALE Ecosystem you are using. This guide covers deployment to **SKALE Base** (permissionless) and the SKALE Ethereum Hubs (Calypso, Europa, Nebula).
...
Once you have credits, deploy your contracts using [Foundry](/cookbook/deployment/setup-foundry), [Hardhat](/cookbook/deployment/setup-hardhat), or your preferred EVM tooling.

Chain details (RPC, Chain ID) can be found in [SKALE on Base](/get-started/quick-start/skale-on-base).
