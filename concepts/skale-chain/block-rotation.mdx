...
description: "How SKALE keeps nodes lightweight while preserving historical access"
---
...
*[Graphic placeholder: Sliding window of retained blocks with archive node storing full history]*
...
*[Graphic placeholder: Performance vs. storage comparison for rotated vs. full history]* 
