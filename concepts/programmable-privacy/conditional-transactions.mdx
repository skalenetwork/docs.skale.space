...
description: "Smart contracts that request decryption of encrypted data on-demand"
---

<Note>
**Available on SKALE Base and SKALE Base Sepolia** — Conditional Transactions are available in sandbox and production environments. Contact the SKALE team at [https://discord.gg/skale](https://discord.gg/skale) for access.
</Note>
...
- [API Reference](/developers/programmable-privacy/api-and-faqs) — Solidity helpers and `submitCTX` docs
