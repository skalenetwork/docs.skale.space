...
*[Graphic placeholder: Client computing magic number → submitting tx with zero balance → SKALE accepts]*
...
*[Graphic placeholder: User flow showing gasless tx vs. sFUEL-funded tx]*
