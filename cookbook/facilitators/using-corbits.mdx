...
- [PayAI Documentation](https://docs.corbits.dev/facilitator/introduction/overview)
- [x402 Protocol Specification](https://x402.org)

---

<Note>
Corbits is a third-party service. Contact the Corbits team for access, pricing, and support information. The URLs in this guide are placeholders and will be updated when the service is publicly available.
</Note>
