...
| Issue | Solution |
|-------|----------|
| ERC-20 token not working | Payer must approve the Prism contract once before first payment — query `GET /contracts` for the contract address on your network |

Use the [x402 Validator](https://www.primer.systems/validate) to debug payment header formatting issues.
