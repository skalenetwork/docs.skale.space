...
The RelAI facilitator has **enabled encrypted transactions** for both **SKALE Base** and **SKALE Base Sepolia** via Programmable Privacy.

**What does this mean?** 
- When a merchant settles any x402 transaction through RelAI facilitator it gets automatically encrypted via threshold encryption and only decrypted at the consensus level

For more information around Programmable Privacy please check [here](/developers/programmable-privacy/intro).
