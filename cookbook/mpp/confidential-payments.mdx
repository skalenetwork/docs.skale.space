...
description: "Accept private payments using confidential tokens (eUSDC) on SKALE chains with Programmable Privacy"
---
...
- SKALE chain with Programmable Privacy access (BITE Sandbox)
...
## Testing on the BITE Sandbox

The BITE Sandbox is the testnet for confidential tokens:
...
- Always test on the BITE Sandbox first
...
- [Programmable Privacy](/concepts/programmable-privacy/intro)
