...
description: "Complete step-by-step guide to implementing a private Rock-Paper-Scissors game using Conditional Transactions (CTX)"
---
...
This tutorial requires access to a CTX-enabled SKALE chain. The demo is configured for the BITE V2 Sandbox 2. Check [Programmable Privacy](/concepts/programmable-privacy/intro) for current feature availability.
</Note>
