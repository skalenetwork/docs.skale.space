...
1. ## Setup Validator
    ...
    *Minimum ETH: 1.0*
    ...
    [https://raw.githubusercontent.com/skalenetwork/concepts/master/releases/mainnet/skale-manager/1.11.0/skale-manager-1.11.0-mainnet-abi.json](https://raw.githubusercontent.com/skalenetwork/concepts/master/releases/mainnet/skale-manager/1.11.0/skale-manager-1.11.0-mainnet-abi.json)

    #### 1.1.4 Fund SRW Wallet with ETH

    Be ready to fund ETH in your self-recharging wallet (SRW). See [Self-recharging wallet documentation](/node-operations/validator-cli/self-recharging-wallets).
    ...
    *Minimum ETH*: 
    ...
    [See the SKALE Validator CLI documentation](/node-operations/validator-cli/overview)
...
2. ## Setup SGX
    ...
    please check [here](/concepts/dkg-with-bls).
...
3. ## Supernode Setup
    ...
    **General requirements**
    ...
    More information can be found here: [Compliance requirements](/node-operations/compliance-requirements)
    ...
    More information can be found [here](/node-operations/node-cli/overview).
    ...
    **Output:**
    ...
    For more details, please see [Node SSL docs](/node-operations/node-cli/node-ssl-setup).
    ...
    **Output:**
    ...
    More information can be found [here](/node-operations/node-cli/releases/v2-0#node-backup).
...
5. ## Post Registration Checks
    ...
    - [ ] Use [watchdog](/node-operations/watchdog/overview) to monitor node status.
