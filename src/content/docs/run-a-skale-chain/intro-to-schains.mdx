...
### After sChain Creation

Once your SKALE Chain is created, we recommend working through the following documentation in order:

1. [sChain Operations](/run-a-skale-chain/schain-operations)
2. [Using Multisig Wallet CLI](/run-a-skale-chain/using-multisig-wallet-cli)
3. [Managing Deployment Permissions](/run-a-skale-chain/managing-deployment-permissions)
4. [Recommended Contract Deployments](/run-a-skale-chain/recommended-contract-deployments)
