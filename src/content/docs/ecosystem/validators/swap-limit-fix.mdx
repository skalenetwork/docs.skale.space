...
> **Note:** If you will encounter with any issues during the following steps, please stop and contact SKALE team.  

> **Warning:** If your node is running on Google Cloud, commands may differ. Please check discussions on [Stack Exchange](https://unix.stackexchange.com/a/495058) or contact SKALE team.
