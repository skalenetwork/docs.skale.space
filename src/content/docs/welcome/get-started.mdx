...
similiar to a table of contents and provides an introduction to the various products and tools
...
| [Seup Requirements](/run-a-skale-chain/setup-requirements) | Understand the setup requirements for a new SKALE Chain |
...
| Section | Description |
| ------- | ----------- |
| [Intro to Solidity](/building-applications/intro-to-solidity) | A quick introduction to the most popular language on SKALE |
| [Zero Gas Fees](/building-applications/gas-fees) | Jump start your knowledge of how to use zero gas fees on SKALE |
| [Picking a Chain](/building-applications/picking-a-chain) | Checkout the various SKALE Hubs to determine where to build |
...
requires strong validator operators to be apart of the nework. Checkout some of the most common resources below
to get started as a valdiator.
...
<Aside type="note">
    ...
    Joining the SKALE Network as a validator means you will be providing resources to the global validaor pool
    and then randomly rotated on and off of active SKALE Chains.
</Aside>

| Section | Description |
| ------- | ----------- |
| [Become a Validator](/run-a-skale-node/become-a-validator) | The perfect starting point to become a SKALE Valdiator |
| [Compliance Requirements](/building-applications/compliance-requirements) |  Checkout the compliance requirements to ensure consistent rewards |
| [Node Types](/building-applications/node-types) | Compare the node types within the SKALE Network |
| [FAQ](/building-applications/faq) | Explore the commonly asked questions from validators |
