...
This distribution method is an application owned distribution method as opposed to an on-chain distribution. The API faciliates sFUEL distribution to users by exposing an API endpoint through a public or private endpoint.
