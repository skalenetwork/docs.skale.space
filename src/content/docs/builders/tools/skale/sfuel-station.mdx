...
2. Once the smart contract is deployed on your SKALE Chain, head over to the [sFUEL Station on Github](https://github.com/Dirt-Road-Development/sfuel-station). Fork the repository, clone the repo down, and open up the folder in your favorite editor or terminal. 
