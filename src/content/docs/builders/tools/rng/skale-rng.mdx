...
1. #### Code to retrieve the random bytes
    ...
    The code bellow showcases how to use the precompiled RNG. It showcases how to access the `getBlockRandom`precompiled at the address `0x18`.
...
3. #### Converting random bytes into uin256
