...
To learn more about filestorage, checkout the [Filestorage Deep Dive](/how-skale-works/filestorage). For an example of how to use filestorage, checkout [using filestorage](/building-applications/using-filestorage).
