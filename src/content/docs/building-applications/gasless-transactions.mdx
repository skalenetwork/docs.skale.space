...
description: Gasless transactions are native to SKALE and enable truely invisible transactions
---
...
EVEN IF there is not a sufficient amount of sFUEL (inclusive of 0 sFUEL) in the sender's account. This also allows gasless transactions to remain fully comaptible with the
