...
Interested in learning more about filestorage first? Checkout the [How Filestorage Works page](/how-skale-works/filestorage). If you are a SKALE Chain Owner or Operator,
