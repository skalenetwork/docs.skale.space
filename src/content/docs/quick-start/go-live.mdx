...
#### Check #1 - Taking Payment/Valued Tokens
...
1. It allows Externally Owned Accounts (EOAs) -- e.g. private keys -- to deploy smart contracts IF
they have the DEPLOYER_ROLE on the ConfigController.

2. It allows smart contracts to deploy other smart contracts without any sort of restrictions -- e.g factories.
...
### Showcase your Project & Request Review
...
the #showcase-your-project. Once you add the **Request Review** tag the SKALE Developer DAO or the Chain Operator you have 
tagged will step in to help you verify that everything is ready to proceed to Mainnet.