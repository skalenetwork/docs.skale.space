...
import ByzantineFormula2 from "../../../../components/Math/ByzantineFormula2.astro";
import MaxByzantineNodes from "../../../../components/Math/MaxByzantineNodes.astro";
...
<math display="inline"><mfrac><mrow><mn>N</mn><mo>-</mo><mn>1</mn></mrow><mn>3</mn></mfrac></math> 
...
As an example, for
<math display="inline"><mn>N</mn><mo>=</mo><mi>17</mi></math>
we get
<math display="inline"><mn>t</mn><mo>=</mo><mi>5</mi></math>
...
<math display="inline"><mn>N</mn><mo>=</mo><mi>1</mi></math>
is divisible by 3.
...
<math display="inline"><mn>h</mn><mo>=</mo><mi>2</mi><mn>t</mn><mo>+</mo><mi>1</mi></math>
...
{/*latexmath:[\left\lceil \frac{size(P)}{N-1} \right\rceil],*/}
except the last chunk the size of
which will be the remainder of 
{/*latexmath:[\frac{size(P)}{N-1}].*/}
