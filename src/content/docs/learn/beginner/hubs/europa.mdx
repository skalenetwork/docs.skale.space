...
A common occurence with new(er) blockchains and more specifically multi-chain networks is liquidity fragmentation and token fragmentation.
...
Alternativley, projects could have all of their own tokens (e.g USDCa, USDCb, USDCc) bridge to Europa for DeFi, however, that results
in liquidity fragementation which the community worked hard to avoid.
