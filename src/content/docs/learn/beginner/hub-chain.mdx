...
| ------------- | -------------------------- | ------------------- | :---------: | :------------------------------------------------------------------: |
| Calypso		| honorable-steel-rasalhague | General             | No          | [<Icon name="external" color="purple" size="1.25rem" />](https://portal.skale.space/chains/calyso) |
| Europa		| elated-tan-skat            | Liquidity           | No          | [<Icon name="external" color="blue" size="1.25rem" />](https://portal.skale.space/chains/europa) |
| Nebula		| green-giddy-denebola       | Gaming              | Yes         | [<Icon name="external" color="green" size="1.25rem" />](https://portal.skale.space/chains/nebula) |
