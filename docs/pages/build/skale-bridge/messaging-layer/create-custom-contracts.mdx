...
```solidity title="SendNumber.sol"
// [!include ~/snippets/skale-bridge/SendNumber.sol]
```
...
::::warning
Don't forget to register your smart contracts on MessageProxyForSchain next! See [Connect Custom Contracts](/build/skale-bridge/messaging-layer/connect-custom-contracts) for next steps!
