...
1. We have created a [custom contract](/build/skale-bridge/messaging-layer/create-custom-contracts)
2. We have [connected](/build/skale-bridge/messaging-layer/connect-custom-contracts) the custom Contracts
...
const SEND_NUMBER_ADDR_A = "0xd2AAa00100000000000000000000000000000000"; // Contract on sChain A
const SEND_NUMBER_ADDR_B = "0xd2AAa00100000000000000000000000000000000"; // Contract on sChain B
...
const sChainBProvider = new JsonRpcProvider(process.env.RPC_URL_B);
