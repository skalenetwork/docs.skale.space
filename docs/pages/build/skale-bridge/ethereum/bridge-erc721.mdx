...
The following is the base interchain token code that meets the above bridging requirements for IMA. It is not recommended to use this directly, but to use a wrapper. See YourInterchainNFT.sol for an example of InterchainERC721 in use.
...
```js title="bridge.js
// [!include ~/snippets/skale-bridge/deposit-erc721.js
```

```js title="bridgeDirect.js
// [!include ~/snippets/skale-bridge/deposit-erc721-direct.js
```
...
```js title="exit.js"
// [!include ~/snippets/skale-bridge/exit-erc721.js
```
