...
2. TokenManagerERC1155 on SKALE Chain - `event ERC1155TokenAdded(SchainHash indexed chainHash, address indexed erc1155OnMainChain, address indexed erc1155OnSchain);`
...
```js title="bridge.js
// [!include ~/snippets/skale-bridge/deposit-erc1155.js
```

```js title="bridgeDirect.js
// [!include ~/snippets/skale-bridge/deposit-erc1155-direct.js
```

```js title="bridgeBatch.js
// [!include ~/snippets/skale-bridge/deposit-erc1155-batch.js
```

```js title="bridgeBatchDirect.js
// [!include ~/snippets/skale-bridge/deposit-erc1155-batch-direct.js
```
...
```js title="exit.js
// [!include ~/snippets/skale-bridge/exit-erc1155.js
```

```js title="exitBatch.js
// [!include ~/snippets/skale-bridge/exit-erc1155-batch.js
```
