...
on SKALE Network contracts. Due to the unique [ownership structure](/skale-chain/run-a-skale-chain/schain-ownership) of a SKALE Chain, this CLI supports with management of your SKALE Chain both from the sChain side and from Mainnet via Gnosis SAFE.
...
To execute via SAFE, see [using SAFE](/skale-chain/run-a-skale-chain/using-safe).
