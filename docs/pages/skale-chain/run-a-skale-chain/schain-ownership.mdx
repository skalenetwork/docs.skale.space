...
::::note
The following is background information on how to operate your sChain using [multisigwallet-cli](/skale-chain/run-a-skale-chain/using-multisig-wallet-cli).
