...
1. ## Setup Validator
    ...
    *Minimum ETH: 1.0*
    ...
    Be ready to fund ETH in your self-recharging wallet (SRW). See [Self-recharging wallet documentation](/run-a-node/validator-cli/self-recharging-wallets).

    *Minimum ETH*: $0.5 * supernode count
    ...
    [See the SKALE Validator CLI documentation](/run-a-node/validator-cli/overview)
...
2. ## Setup SGX
    ...
    please check [here](/skale-chain/dkg-with-bls).
...
3. ## Supernode Setup
    ...
    **General requirements**
    ...
    More information can be found here: [Compliance requirements](/run-a-node/compliance-requirements)
    ...
    More information can be found [here](/run-a-node/node-cli/overview).
    ...
    **Output:**
    ...
    For more details, please see [Node SSL docs](/run-a-node/node-cli/node-ssl-setup).
    ...
    **Output:**
    ...
    More information can be found [here](/run-a-node/node-cli/releases/v2-0#node-backup).
...
5. ## Post Registration Checks
    ...
    - [ ] Use [watchdog](/run-a-node/watchdog/overview) to monitor node status.
