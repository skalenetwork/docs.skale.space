...
![Enable the custom data toggle](../../../assets/developers/safe-custom-data-toggle.png)
...
![Transaction Prepared in SAFE](../../../assets/developers/safe-transaction-prepared.png)
