...
![Click on Transaction Builder](../../../assets/developers/run-a-skale-chain/safe-transaction-builder.png)

3. Enable the toggle **Custom Data**

![Enable the custom data toggle](../../../assets/developers/run-a-skale-chain/safe-custom-data-toggle.png)
...
![Transaction Prepared in SAFE](../../../assets/developers/run-a-skale-chain/safe-transaction-prepared.png)
