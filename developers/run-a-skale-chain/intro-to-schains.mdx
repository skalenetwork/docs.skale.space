...
1. Follow the [Setup Requirements](/developers/run-a-skale-chain/setup-requirements)
2. Determine which features you want to [customize on your SKALE Chain](/developers/run-a-skale-chain/customize-schain)
3. SKALE Chain Creation. Join us in [Discord](https://discord.gg/skale) to request a SKALE Chain