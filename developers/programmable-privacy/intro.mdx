...
> **Note:** All Programmable Privacy features are currently available on testnet (SKALE Base Sepolia). Mainnet deployment is coming soon. For mainnet access or questions, reach out to the SKALE team on [Discord](https://discord.gg/skale).
