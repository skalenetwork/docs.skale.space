---
title: "Programmable Privacy API"
description: "Technical documentation for the TypeScript SDK, Solidity helpers, and JSON-RPC methods"
---

## API Reference

This section provides detailed technical documentation for Programmable Privacy's APIs, both off-chain (TypeScript SDK) and onchain (Solidity helpers).
...
Encrypted transactions modify standard Ethereum transaction structure:
