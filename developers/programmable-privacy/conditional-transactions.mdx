...
description: "Developer guide for building smart contracts with on-demand decryption using CTX on SKALE"
---

Conditional Transactions (CTX) enable smart contracts to store encrypted data and request decryption directly from within Solidity and the EVM. While Encrypted Transactions focus on encrypting transaction payloads for privacy, Conditional Transactions are transactions initiated by smart contracts in one block and executed in the next block with decrypted data.

<Note>
This example uses the BITE V2 Sandbox 2. Contact the SKALE Team at [https://discord.gg/skale](https://discord.gg/skale) for access.
</Note>
...
- **API Reference**: [API & FAQs](/developers/programmable-privacy/api-and-faqs)
