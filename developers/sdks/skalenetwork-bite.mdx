---
title: "Privacy (BITE) SDK"
description: "Privacy SDK enabling developers to consume native primary primiatives through SKALE's BITE Protocol"
---
...
<Note>
The SDK works with any BITE-enabled SKALE chain. Right now, BITE is available on [SKALE Base Mainnet and Testnet](/get-started/quick-start/skale-on-base) only.
</Note>
