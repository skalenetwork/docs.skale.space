...
<Note>
Encrypted transaction amounts use threshold encryption to hide transaction amounts while maintaining verifiability. Requires a SKALE chain with Programmable Privacy.
</Note>
...
<Warning>
Custom chain configurations support **standard ERC-20 transfers** and **EIP-3009 gasless payments** only. Encrypted transaction amounts and confidential tokens require built-in chain configurations with specific contract addresses and cannot be used with custom chains.
</Warning>
