...
- **[Scalability](/get-started/quick-start/skale-on-base):** It's in the name. Build on the only decentralized compute network designed to support you at every stage of your growth.
...
- **[Randomness](/developers/native-features/random-number-generation):** Secure and decentralized random number generation (RNG) is available on every SKALE Chain. No need to rely on third-party services or oracles any
longer; access RNG (a VRF alternative) directly onchain instantly and for free.
- **[Filestorage](/developers/native-features/using-filestorage):** Store files and even websites directly on a SKALE Chain. A great alternative to IPFS and other decentralized storage solutions for static files.
...
<CardGroup cols={2}>
  <Card title="Solidity Quickstart" href="/developers/solidity-quickstart">
    Deploy your first smart contract to SKALE
  </Card>
  <Card title="Using Filestorage" href="/developers/native-features/using-filestorage">
    Learn how to store files onchain
  </Card>
  <Card title="SKALE SDKs" href="/developers/sdks/overview">
    Explore official SDKs and libraries
  </Card>
  <Card title="Developer Tools" href="/developers/tools/overview">
    Discover tools for building on SKALE
  </Card>
</CardGroup>
