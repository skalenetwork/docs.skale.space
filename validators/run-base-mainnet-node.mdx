---
title: Run a Node on Base Mainnet
description: Setup Process for a SKALE Validator Node on Base Mainnet
---
...
1. **Prepare for Validator Registration**
   ...
   **Decide your commission fee**
   ...
   This new validator would have to link supernodes (old validator supernodes cannot be rolled into a new validator commission fee).
...
11. **Enable SGX**
    ...
    **Check driver installation:**
    ...
    If you don't see the neither of isgx and sgx_enclave device, you need to troubleshoot your driver installation from [here](https://github.com/skalenetwork/sgxwallet/blob/develop/docs/common/enabling-sgx.md).
...
19. **Configure .env**
      ...
      - `CONTAINER_CONFIGS_DIR` - Directory for container configuration files
      - `DOCKER_LVMPY_VERSION` - Version of the docker-lvmpy volume driver
      ...
      - `MONITORING_CONTAINERS` - Enable monitoring containers (`True`/`False`)
      - `DEFAULT_GAS_PRICE_WEI` - Default gas price in wei for Base Mainnet transactions
      ...
      DOCKER_LVMPY_VERSION="1.0.2-stable.0"
      BLOCK_DEVICE="/dev/nvme1n1"
      SGX_URL=[SGX_URL]
      TG_API_KEY=""
      TG_CHAT_ID=""
      MONITORING_CONTAINERS="True"
      DEFAULT_GAS_PRICE_WEI="10000000"
      ENV_TYPE="mainnet"
      BITE="True"
      ```
...
29. **Register Node with Node CLI**
      ...
      <Note>
      Before proceeding, you will need to have at least  **1 ETH** on Base. Also amount of delegated skale tokens need to be more or equal to minimum staking amount.
      </Note>
