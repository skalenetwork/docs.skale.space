...
<Accordion title="How do I change my Node’s IP address?">
  See [Changing Node IP](/validators/node-cli/changing-node-ip)
</Accordion>


<Accordion title="How should validators configure backup and restore?">
  ...
  Please check [supernode backup](https://github.com/skalenetwork/skale-node-cli/blob/develop/README.md#node-commands) and [sgx_backup](https://github.com/skalenetwork/sgxwallet/blob/develop/docs/admin/backup-procedure.md) to learn more about how to back up the supernode or SGXWallet, and restore.
</Accordion>

<Accordion title="Where are the network communications between containers, shared configuration files, and volumes stored?">
...
<Accordion title="How do I access the SKALE Chain's IP and ports?">
...
<Accordion title="What are the following Supernode ports used for?">
...
<Accordion title="Can I use Kubernetes?">
...
<Accordion title="Where can I find the SKALE Supernode logs?">
...
<Accordion title="Why is SGX crashing after machine reboot?">
...
<Accordion title="Supernode update procedure">
