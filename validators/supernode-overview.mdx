...
installed with the [SKALE Node CLI](/validators/node-cli/overview). SKALE Admin evaluates the prospective supernode to ensure that it's upholding
...
- [Microsoft Azure](https://www.intel.com/content/www/us/en/developer/articles/technical/microsoft-azure-confidential-computing-with-intel-sgx.html)
