...
Latest Mainnet software versions are defined [here](https://github.com/skalenetwork/concepts/tree/master/releases):
...
Test: `http://YOUR_SKALE_NODE_IP:3009/status/SKALE Chain-containers-versions`
...
Example response:
```shell
{"data": [{"image": "skalenetwork/SKALE Chain:3.5.12-stable.1", "name": "skale_schain_beautiful-al-anz", "state": {"Status": "running", "Running": true, "Paused": false, "Restarting": false, "OOMKilled": false, "Dead": false, "Pid": 21709, "ExitCode": 0, "Error": "", "StartedAt": "2021-04-26T14:49:51.705052477Z", "FinishedAt": "0001-01-01T00:00:00Z"}}, ...
```
